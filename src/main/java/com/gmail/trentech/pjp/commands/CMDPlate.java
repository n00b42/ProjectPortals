...
public class CMDPlate implements CommandExecutor {
	...
	public CMDPlate(){
		...
		help.setSyntax(" /plate <destination> [-c <x,y,z>] [-d <direction>] [-b] [-p <price>]\n /pp <destination> [-c <x,y,z>] [-d <direction>] [-b] [-p <price>]");
	...
	private Text invalidArg(){
		Text t1 = Text.of(TextColors.RED, "Usage: /plate <destination> [-c <x,y,z>] ");
