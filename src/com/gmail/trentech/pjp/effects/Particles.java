...
public enum Particles {
	...
	CLOUD(new Particle("CLOUD", ParticleTypes.CLOUD, 60, false)), HEART(new Particle("HEART", ParticleTypes.HEART, 90, false)),
	...
	NOTE(new Particle("NOTE", ParticleTypes.NOTE, 80, false)), REDSTONE(new Particle("REDSTONE", ParticleTypes.REDSTONE, 10, true)),
	SPELL(new Particle("SPELL", ParticleTypes.SPELL, 10, false)), WATER_BUBBLE(new Particle("WATER_BUBBLE", ParticleTypes.WATER_BUBBLE, 5, false)),
	CRIT_MAGIC(new Particle("CRIT_MAGIC", ParticleTypes.CRIT_MAGIC, 10, false)), CRIT(new Particle("CRIT", ParticleTypes.CRIT, 10, false)),
	SNOWBALL(new Particle("SNOWBALL", ParticleTypes.SNOWBALL, 10, false)), SLIME(new Particle("SLIME", ParticleTypes.SLIME, 10, false)),
